...
5. If you have enough information to provide a solid overview:
   - Identify what specific decisions are still needed from the user to move this to a "🤖 AI: Triage" state.
   - Wrap your brief in <COMMENT> tags.
   - End with: <NEXT_STATE>🤖 AI: Draft Plan</NEXT_STATE>
6. If the request is so vague that you cannot even perform basic technical discovery:
   ...
   - End with: <NEXT_STATE>👤 HUMAN: Needs Clarification</NEXT_STATE>
